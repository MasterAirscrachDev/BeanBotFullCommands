# channelgoeshere Commands (Last Updated 1/06/2023 11:48:34 AM)
### Base Commands
help<The Help Command | Catagories: Beans, Minigames, Events, About, TTS. or get a full list here: github.com/MasterAirscrachDev/BeanBotFullCommands/blob/main/channelgoeshere%20Commands.md
 ...
 <br>freebeans<Get 100 Free Beans once per stream
 ...
 <br>tts<Get Text To Speech | !tts (text) (costs 100 Beans)
...
### Custom Commands
cards<SIMPLE CARDS BY BLUE | 100 Beans
 <br>mc<lists my FNAF: Security Breach commands
 <br>qdrop<[CAN BE USED TO DROP AN ITEM IN THE SLOT IM USING COST] | 200 Beans
 <br>random<[SWAP TO RANDOM ITEM IN MY HOTBAR AND DROP IT] | 300 Beans
 <br>stop<[CAN BE USED TO STOP ME FROM MOVING] | 500 Beans
 <br>bombs<3 2 1 BOOM! (BOMB) | 500 Beans
 <br>emergency<Emergency SUSSY SUSSY | 100 Beans
 <br>hello<BB Hello :D | 150 Beans
 <br>honk<BOOPS FREDDY NOSE :3 TEHE | 100 Beans
 <br>jumpscare<JUMPSCARE OOOO SCAWWY | 500 Beans
 <br>laugh<hahahah LOL | 200 Beans
 <br>pipe<ahhhh PIPES | 200 Beans
 <br>sandwich<Obama sandwich - REQUESTED BY LOLANGE46  | 300 Beans
 <br>sound<lists of sounds: !pipe | !rats | !wizard | !number1
 <br>terrible<Terrible | 200 Beans
 <br>ticking<Ticking | 300 Beans
 <br>welldone<welldone | 400 Beans
 <br>wizard<wizard | 100 Beans
 <br>