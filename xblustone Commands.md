...
!Steal is disabled <br> 
!Openminigames costs 10000 Balls and lasts 3 minutes <br>
## Custom Commands <br>
### CARDS <br>
```js
...
!openminigames<Unlocks the minigames for 3 minutes, can be stacked | !openminigames (costs 10,000 Balls)
...
!steal<Stealing is disabled by the streamer
...
!drop<collect a drop of 250 balls | !drop
...
!about bot<(Running BeanBot.exe v1.3.5) Beanbot׳s goal is to replace twitch channel points with built-in games and fully customisable chat-to-game interactions
...
!buytts<buy TTS Tokens, 150 Balls, 5% discount per token | !buyTTS (amount)
