...
## Base Commands 
```js
!help<The Help Command | Catagories: coins, Minigames, Events, About, TTS. or get a full list here: github.com/MasterAirscrachDev/BeanBotFullCommands/blob/main/ashzoro917%20Commands.md
!coins<You Gain 1-3 coins Every Minute Your Active in Chat | Commands: !coins !Givecoins, !coinBoard, !Freecoins, !Floor, !Steal
!givecoins<Give someone coins | !givecoins (@user) (amount)
!coinboard<View The Leaderboard
!freecoins<Get 100 Free coins once per stream
!floor<Check the floor for any {Program.config.currencies} | {Program.config.prefix}floor
!editcoins<[STREAMER] Edit a users coins | !editcoins (optional @user) (amount) | edit gold !editcoins (@user) (amount) gold
!minigames<Minigames to play in chat | Commands: !OpenMinigames !Coinflip  !OneUps !Quickmath 
!openminigames<Unlocks the minigames for 6 minutes, can be stacked | !openminigames (costs 10,000 coins)
!coinflip<Flip a coin, if you bet you will get double your bet on correct guess | !coinflip (optional:[heads/tails] [amount]) betting is capped at 1000 coins
...
!playwithfire<Play a game with fire, if you win you will get 10x your bet, if you lose you get banished from chat for 2 minutes | !playwithfire (bet) betting is capped at 1000 coins
...
!buypadlock<buy a padlock to stop people stealing from you | !buypadlock (tier[1-3]) 1: 10% coins for 10, 2: 20% coins for 20M, 3: 30% coins for 30M and notification on break
...
!drop<collect a drop of 50 coins | !drop
...
!buytts<buy TTS Tokens, 50 coins, 5% discount per token | !buyTTS (amount)
!tts<Get Text To Speech | !tts (text) (costs 1 TTS Token per 25 letters), | !buyTTS | !editTTS
...
!goldencoinblessing<activates the power of a golden coin
!reload<[MOD] Reloads the config file and all custom commands | !reload
!prestige<Prestige your coins | !prestige (costs 1,000,000,000 coins)
