...
## Base Commands 
```js
!help<The Help Command | Catagories: Beans, Minigames, Events, About, TTS. or get a full list here: github.com/MasterAirscrachDev/BeanBotFullCommands/blob/main/awesomebean_bot%20Commands.md
...
!freebeans<Get 100 Free Beans once per stream
...
!drop<collect a drop of 50 beans | !drop
...
!buytts<buy TTS Tokens, 150 Beans, 5% discount per token | !buyTTS (amount)
